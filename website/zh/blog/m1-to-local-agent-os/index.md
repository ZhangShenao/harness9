...
这份约定让默认的 `noopObserver` 几乎不用额外成本，也让 OpenTelemetry 能把一次对话里模型和工具的过程串起来。说白了，M1 的一个坚持是：内核要尽量文档，想加的新功能要有边界，能看得见、查得清。
...
一个人写代码还是蛮无聊的，如果大家对 harness9 这个项目感兴趣，欢迎一起来共建呀~